...
sudo apt install sway-notification-center alacritty xdg-desktop-portal-hyprland git hyprland polkit-kde-agent-1 waybar hyprpaper 
...
# Compile Hyprpicker
sudo apt install cmake libcairo2-dev libhyprutils0 pango1.0-tools
